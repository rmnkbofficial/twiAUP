var apiTools = {
	...
	vote_post: function (pID, expectedResponse) {
		fn = arguments.callee.toString().substring(0, arguments.callee.toString().indexOf("("));
		my_args = arguments;
		var jqxhr = $.ajax( "api/vote.php?pID="+pID, { async : false})
		.done(function(resp) {
			apiTools.evaluateResp(resp,expectedResponse,this.url,my_args);
		})
		.fail(function() {
	...
	already_voted: function (pID, expectedResponse) {
		fn = arguments.callee.toString().substring(0, arguments.callee.toString().indexOf("("));
		my_args = arguments;
		var jqxhr = $.ajax( "api/already_voted.php?pID="+pID, { async : false})
		.done(function(resp) {
			apiTools.evaluateResp(resp,expectedResponse,this.url,my_args);
		})
		.fail(function() {
	...
	get_num_votes: function (pID, expectedResponse) {
		fn = arguments.callee.toString().substring(0, arguments.callee.toString().indexOf("("));
		my_args = arguments;
		var jqxhr = $.ajax( "api/get_num_votes.php?pID="+pID, { async : false})
		.done(function(resp) {
			apiTools.evaluateResp(resp,expectedResponse,this.url,my_args);
		})
		.fail(function() {
	...
	get_num_votes_of_user: function (uID, expectedResponse) {
		fn = arguments.callee.toString().substring(0, arguments.callee.toString().indexOf("("));
		my_args = arguments;
		var jqxhr = $.ajax( "api/get_num_votes_of_user.php?uID="+uID, { async : false})
		.done(function(resp) {
			apiTools.evaluateResp(resp,expectedResponse,this.url,my_args);
		})
		.fail(function() {
